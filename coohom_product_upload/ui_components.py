...
from coohom_product_upload.file_utils import get_file_info, get_status_description, estimate_upload_time
...
def handle_upload_process(uploaded_file, uploader, model_config=None):
    ...
    Returns:
        tuple: (success, upload_task_id)
    """
    from coohom_product_upload.file_utils import create_zip_from_file
